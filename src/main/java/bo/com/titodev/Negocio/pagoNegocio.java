...
import bo.com.titodev.Dato.pagoDato;
...
public class pagoNegocio {
    ...
    private pagoDato eModel;
    private String respuesta;

    public pagoNegocio() {
        this.eModel = new pagoDato();
    }
    ...
    public String create(LinkedList<String> params) {
        ...
        eModel = new pagoDato(0,Double.parseDouble(params.get(0)),Date.valueOf(params.get(1)),params.get(2),Integer.valueOf(params.get(3)));
        if (eModel.create()) {
    ...
    public String update(LinkedList<String> params) {
        ...
        eModel = new pagoDato(Integer.parseInt(params.get(0)),Double.parseDouble(params.get(1)),Date.valueOf(params.get(2)),params.get(3),Integer.valueOf(params.get(4)));
    ...
    private void validateCreate(LinkedList<String> params) {
        ...
        if (!validatorUtils.validateNumber(params.get(3))) {
            this.respuesta = "Los Codigo de la inscripcion Materia_estudiante  no valida";
            return;
        }
