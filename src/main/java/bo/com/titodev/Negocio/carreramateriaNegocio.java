...
import bo.com.titodev.Dato.carreraMateriaDato;
import bo.com.titodev.Utils.validatorUtils;
import java.util.LinkedList;

public class carreramateriaNegocio {

    private carreraMateriaDato cModel;
    private String respuesta;

    public carreramateriaNegocio() {
        this.cModel = new carreraMateriaDato();
    }
    ...
    public String create(LinkedList<String> params) {
        ...
        cModel = new carreraMateriaDato(Integer.valueOf(params.get(0)),params.get(1),params.get(2) );
        if (cModel.create()) {
