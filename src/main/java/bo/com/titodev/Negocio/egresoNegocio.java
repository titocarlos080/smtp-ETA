...
import bo.com.titodev.Dato.egresoDato;
...
public class egresoNegocio {
    ...
    private egresoDato eModel;
    private String respuesta;

    public egresoNegocio() {
        this.eModel = new egresoDato();
    }
    ...
    public String create(LinkedList<String> params) {
        ...
        eModel = new egresoDato(0,Double.parseDouble(params.get(0)),Date.valueOf(params.get(1)),params.get(2),Integer.valueOf(params.get(3)));
        if (eModel.create()) {
