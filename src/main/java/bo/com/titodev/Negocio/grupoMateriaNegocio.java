...
import bo.com.titodev.Dato.grupoMateriaDato;
import bo.com.titodev.Utils.validatorUtils;
import java.util.LinkedList;

public class grupoMateriaNegocio {

    private grupoMateriaDato mModel;
    private String respuesta;

    public grupoMateriaNegocio() {
        this.mModel = new grupoMateriaDato();
    }
    ...
    public String create(LinkedList<String> params) {
       ...
       //String sigla, String descripcion, String materia_sigla, String carrera_sigla, int docente_id 
        mModel = new grupoMateriaDato(params.get(0),params.get(1),params.get(2),params.get(3),Integer.valueOf(4));
