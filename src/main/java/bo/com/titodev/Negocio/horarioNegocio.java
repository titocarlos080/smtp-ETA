package bo.com.titodev.Negocio;
 ...
 import bo.com.titodev.Dato.horarioDato;
...
public class horarioNegocio {
    ...
    private horarioDato hModel;
    private String respuesta;

    public horarioNegocio() {
        this.hModel = new horarioDato();
    }
    ...
    public String create(LinkedList<String> params) {
        ...
        hModel = new horarioDato(0,Time.valueOf(params.get(0)),Time.valueOf(params.get(1)));
        if (hModel.create()) {
    ...
    public String update(LinkedList<String> params) {
        ...
        hModel = new horarioDato( Integer.parseInt(params.get(0)),Time.valueOf(params.get(1)),Time.valueOf(params.get(2)));
