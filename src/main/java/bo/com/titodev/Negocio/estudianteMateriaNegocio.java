...
import bo.com.titodev.Dato.estudiantemateriaDato;
import bo.com.titodev.Utils.validatorUtils;
import java.util.LinkedList;
import java.sql.Date;
 
public class estudianteMateriaNegocio {

    private estudiantemateriaDato emModel;
    private String respuesta;

    public estudianteMateriaNegocio() {
        this.emModel = new estudiantemateriaDato();
    }
    ...
    public String create(LinkedList<String> params) {
        ...
        emModel = new estudiantemateriaDato(0, Date.valueOf( params.get(0)), params.get(1),  params.get(2));
        if (emModel.create()) {
    ...
    public String update(LinkedList<String> params) {
        ...
        emModel = new estudiantemateriaDato(Integer.parseInt(params.get(0)), Date.valueOf( params.get(1)), params.get(2),  params.get(3));
        if (emModel.update()) {
