...
import bo.com.titodev.Dato.grupoMateriaHorarioDato;
...
public class grupoMateriaHorarioNegocio {
    ...
    public grupoMateriaHorarioNegocio() {
        this.gmhModel = new grupoMateriaHorarioDato();
    }
    ...
    public String create(LinkedList<String> params) {
        ...
        gmhModel = new grupoMateriaHorarioDato(params.get(0), Integer.parseInt(params.get(1)),
    ...
    private void validateCreate(LinkedList<String> params) {
        ...
        // int docente_id
        gmhModel = new grupoMateriaHorarioDato();
        if (params.size() != 3) {
