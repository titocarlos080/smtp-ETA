...
public class personaDato {
    ...
    public personaDato(String ci, String nombre, String apellido_pat, String apellido_mat, String telefono, char sexo, java.sql.Date fecha_nacimiento, int usuario_id) {
        this.ci = ci;
        this.nombre = nombre;
