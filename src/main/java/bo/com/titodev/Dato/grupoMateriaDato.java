...
public class grupoMateriaDato {
    ...
    public grupoMateriaDato() {
    }

    public grupoMateriaDato(String sigla, String descripcion, String materia_sigla, String carrera_sigla, int docente_id) {
        this.sigla = sigla;
